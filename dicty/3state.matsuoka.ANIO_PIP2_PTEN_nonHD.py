...
nPTENa_ss = nANIO_total-nANIO_ss
nPTENp2_ss = nPIP2_total-nPIP2_ss
nPTEN_ss = nPTEN_total-nPTENvol_ss-nPTENa_ss-nPTENp2_ss
...
Ze = 3.0/12*(nPIP2_ss/nVolumeVacant_total)*nPTENvol_ss*1/PTENvol_dt
a = 1.63959*nPTENvol_ss
r.p = a/Ze
r.LogEvent = LogEvent
r.LogStart = 5
...
Ze = 3.0/12*(nANIO_ss/nVolumeVacant_total)*nPTENvol_ss*1/PTENvol_dt
a = 0.48894*nPTENvol_ss
r.p = a/Ze
r.LogEvent = LogEvent
r.LogStart = 5
...
r.VariableReferenceList = [['_', 'Variable:/:PTEN', '1']]
#r.k = 0.31983
Ze = 3.0/12*(nVacant_ss/nVolumeVacant_total)*nPTENvol_ss*1/PTENvol_dt 
a = 0.31983*nPTENvol_ss
r.p = a/Ze
r.LogEvent = LogEvent
r.LogStart = 5
