...
a_to_p2 = 1.0
a_to_p3 = 1.0
p2_to_v = charged_to_v
p2_to_a = 1.0
p2_to_p2 = 1.0
p2_to_p3 = 1.0
p3_to_v = charged_to_v
p3_to_a = 1.0
p3_to_p2 = 1.0
p3_to_p3 = 1.0
...
theSimulator.createEntity('Variable', 'Variable:/:LENGTHY').Value = 10e-6
theSimulator.createEntity('Variable', 'Variable:/:LENGTHZ').Value = 0.26e-6
...
r.Value = 0
r.Name = "HD"
r = theSimulator.createEntity('Variable', 'Variable:/:PI3Kvol')
r.Value = 0
r.Name = "HD"

theSimulator.createEntity('Variable', 'Variable:/:ANIO').Value = 0
theSimulator.createEntity('Variable', 'Variable:/:PIP2').Value = 7000
theSimulator.createEntity('Variable', 'Variable:/:PIP3').Value = 0
theSimulator.createEntity('Variable', 'Variable:/:PTEN').Value = 1000
theSimulator.createEntity('Variable', 'Variable:/:PI3K').Value = 1000
...
#Membrane recruitment-----------------------------------------------------------
binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v1')
binder.VariableReferenceList = [['_', 'Variable:/:PTENvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PTEN','1']]
binder.k = PTENvol_to_v

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v2')
binder.VariableReferenceList = [['_', 'Variable:/:PTENvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:ANIO','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PTENa','1']]
binder.k = PTENvol_to_a

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v3')
binder.VariableReferenceList = [['_', 'Variable:/:PTENvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:ANIOc','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PTENac','1']]
binder.k = PTENvol_to_a

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v4')
binder.VariableReferenceList = [['_', 'Variable:/:PTENvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP2','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PTENp2','1']]
binder.k = PTENvol_to_p2

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v5')
binder.VariableReferenceList = [['_', 'Variable:/:PTENvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP2c','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PTENp2c','1']]
binder.k = PTENvol_to_p2

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v6')
binder.VariableReferenceList = [['_', 'Variable:/:PTENvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP3','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PTENp3','1']]
binder.k = PTENvol_to_p3

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v7')
binder.VariableReferenceList = [['_', 'Variable:/:PTENvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP3c','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PTENp3c','1']]
binder.k = PTENvol_to_p3

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v8')
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:Vacant','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PI3K','1']]
binder.k = PI3Kvol_to_v

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v9')
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:ANIO','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PI3Ka','1']]
binder.k = PI3Kvol_to_a

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v10')
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:ANIOc','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kac','1']]
binder.k = PI3Kvol_to_a

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v11')
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP2','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kp2','1']]
binder.k = PI3Kvol_to_p2

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v12')
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP2c','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kp2c','1']]
binder.k = PI3Kvol_to_p2

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v13')
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP3','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kp3','1']]
binder.k = PI3Kvol_to_p3

binder = theSimulator.createEntity('SpatiocyteNextReactionProcess', 'Process:/:v14')
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kvol','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PIP3c','-1']]
binder.VariableReferenceList = [['_', 'Variable:/:PI3Kp3c','1']]
binder.k = PI3Kvol_to_p3
