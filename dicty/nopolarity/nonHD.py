...
#c1 = steady state fraction of f4 below S1
#c2 = ss fraction of f4 below S2
#c3 = ss fraction of f4 below S3
#c1 + c2 + c3 = 1
#tot = nPTENvol_ss*(kV1*c1*nPIP2_ss + kV2*c2*nANIO_ss + kV3*c3*nVacant_ss)
#kV1*c1*nPTENvol_ss*nPIP2_ss/tot = 0.24
#kV2*c2*nPTENvol_ss*nANIO_ss/tot = 0.60
#kV3*c3*nPTENvol_ss*nVacant_ss/tot = 0.16
...
#print nPIP2_total, nANIO_total, nVacant_total
#print nPTENp2_ss, nPTENa_ss, nPTEN_ss
#tot = prob1*nPIP2_ss + prob2*nANIO_ss + prob3*nVacant_ss
#print prob1*nPIP2_ss/tot, prob2*nANIO_ss/tot, prob3*nVacant_ss/tot
#print kV1/(kV1+kV2+kV3), kV2/(kV1+kV2+kV3), kV3/(kV1+kV2+kV3)
#print kV1, kV2, kV3
