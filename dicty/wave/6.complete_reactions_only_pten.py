...
PTENa_to_PTENv = k23
PTENac_to_PTENv = k23
PTENp3_to_PTENv = k23 #assuming PTENp3 is like PTEN in state 2
PTENp3c_to_PTENv = k23 #assuming PTENp3 is like PTEN in state 2
...
PTENa_to_v = 1.0 #maintain diffusion coefficient by swapping with vacant
PTENa_to_a = 1.0
PTENa_to_ac = 1.0
PTENa_to_p2 = p21
PTENa_to_p2c = p21c
...
PTENac_to_v = 1.0 #maintain diffusion coefficient by swapping with vacant
PTENac_to_a = 1.0
PTENac_to_ac = 1.0
PTENac_to_p2 = p21
PTENac_to_p2c = p21c
...
PTENp2_to_v = 1.0 #maintain diffusion coefficient by swapping with vacant
PTENp2_to_a = p12
PTENp2_to_ac = p12c
PTENp2_to_p2 = 1.0
PTENp2_to_p2c = 1.0
...
PTENp2c_to_v = 1.0 #maintain diffusion coefficient by swapping with vacant
PTENp2c_to_a = p12
PTENp2c_to_ac = p12c
PTENp2c_to_p2 = 1.0
PTENp2c_to_p2c = 1.0
...
PTENp3_to_v = 1.0 #maintain diffusion coefficient by swapping with vacant
PTENp3_to_a = 1.0
PTENp3_to_ac = 1.0
PTENp3_to_p2 = p21
PTENp3_to_p2c = p21c
...
PTENp3c_to_v = 1.0 #maintain diffusion coefficient by swapping with vacant
PTENp3c_to_a = 1.0
PTENp3c_to_ac = 1.0
PTENp3c_to_p2 = p21
PTENp3c_to_p2c = p21c
...
l.VariableReferenceList = [['_', 'Variable:/:PTENp3']]  #6
l.VariableReferenceList = [['_', 'Variable:/:PTENp3c']] #7
l.VariableReferenceList = [['_', 'Variable:/:PI3Kvol']] #8
l.VariableReferenceList = [['_', 'Variable:/:PI3K']]    #9
l.VariableReferenceList = [['_', 'Variable:/:PI3Ka']]   #10
l.VariableReferenceList = [['_', 'Variable:/:PI3Kac']]  #11
l.VariableReferenceList = [['_', 'Variable:/:PI3Kp2']]  #12
l.VariableReferenceList = [['_', 'Variable:/:PI3Kp2c']] #13
l.VariableReferenceList = [['_', 'Variable:/:PI3Kp3']]  #14
l.VariableReferenceList = [['_', 'Variable:/:PI3Kp3c']] #15
l.VariableReferenceList = [['_', 'Variable:/:PIP2']]    #16
l.VariableReferenceList = [['_', 'Variable:/:PIP2c']]   #17
l.VariableReferenceList = [['_', 'Variable:/:PIP3']]    #18
l.VariableReferenceList = [['_', 'Variable:/:PIP3c']]   #19
l.LogInterval = 1e-1
l.LogEnd = duration
