...
print "PTENvol:", int(v[7]), v[7]/(v[0]+v[1]+v[2]+v[3]+v[4]+v[5]+v[6]+v[7])
print "PTEN total:", int(v[0]+v[1]+v[2]+v[3]+v[4]+v[5]+v[6]+v[7])
print "PTEN_p2:", int(v[0]+v[2])
print "PTEN_p3:", int(v[1]+v[3])
print "PI3K_p2:", int(v[10]+v[11])
print "PI3K_p3:", int(v[16]+v[17])
print "PI3Kv:", int(v[8])
print "PI3K_membrane:", int(v[8]+v[10]+v[11]+v[16]+v[17])
print "PI3Kvol:", int(v[9])
print "PI3K total:", int(v[8]+v[10]+v[11]+v[9]+v[16]+v[17])
print "PIP3_free:", int(v[12]+v[14])
print "PIP2_free:", int(v[13]+v[15])
pip3 = int(v[1]+v[3]+v[12]+v[14]+v[16]+v[17])
print "PIP3:", pip3
pip2 = int(v[0]+v[2]+v[10]+v[11]+v[13]+v[15])
print "PIP2:", pip2
