...
sim.createEntity('Variable', 'Variable:/Cell2:LENGTHX').Value = 13e-6
sim.createEntity('Variable', 'Variable:/Cell2:LENGTHY').Value = 11e-6
sim.createEntity('Variable', 'Variable:/Cell2:LENGTHZ').Value = 8e-6
...
sim.createEntity('Variable', 'Variable:/Cell:LENGTHZ').Value = 4e-6
...
l.VariableReferenceList = [['_', 'Variable:/Cell/Cortex:VACANT']]
l.VariableReferenceList = [['_', 'Variable:/Cell2/Cortex:VACANT']]
