...
sim.createEntity('Variable', 'Variable:/:LENGTHX').Value = 14.5e-6*1.2
sim.createEntity('Variable', 'Variable:/:LENGTHY').Value = 12e-6*1.2
sim.createEntity('Variable', 'Variable:/:LENGTHZ').Value = 5.5e-6*1.2
