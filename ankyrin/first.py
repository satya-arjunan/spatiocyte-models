...
sim.createEntity('Variable', 'Variable:/:LENGTHX').Value = 2e-6
sim.createEntity('Variable', 'Variable:/:LENGTHY').Value = 2e-6
sim.createEntity('Variable', 'Variable:/:LENGTHZ').Value = 2e-6
...
sim.createEntity('Variable', 'Variable:/:Ankyrin').Value = 100
sim.createEntity('Variable', 'Variable:/:Gag').Value = 100
