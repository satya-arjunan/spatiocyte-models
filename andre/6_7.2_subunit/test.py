...
theSimulator.createEntity('Variable', 'Variable:/:LENGTHY').Value = 1e-7*5
theSimulator.createEntity('Variable', 'Variable:/:LENGTHZ').Value = 1e-7*5
...
theSimulator.createEntity('Variable', 'Variable:/Surface:PS').Value = 450*25
...
theSimulator.createEntity('Variable', 'Variable:/Surface:RAS').Value = 6*25
theSimulator.createEntity('Variable', 'Variable:/Surface:Vacant')
