...
sim.createEntity('Variable', 'Variable:/:LENGTHX').Value = 2.175e-6
sim.createEntity('Variable', 'Variable:/:LENGTHY').Value = 2.175e-6
sim.createEntity('Variable', 'Variable:/:LENGTHZ').Value = 2.175e-6
sim.createEntity('Variable', 'Variable:/:VACANT')
sim.createEntity('Variable', 'Variable:/:MinDatp').Value = 0
sim.createEntity('Variable', 'Variable:/:MinDadp').Value = 1300
...
sim.createEntity('Variable', 'Variable:/Surface:MinDEE').Value = 700
