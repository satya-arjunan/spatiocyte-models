...
rodsLengthX[nRod-1] = rodsLengthX[nRod-1]-4e-6
rodsLengthX[nRod-2] = rodsLengthX[nRod-2]-2e-6
...
sim.createEntity('Variable', 'Variable:/Soma:MinDatp').Value = 4652/2
sim.createEntity('Variable', 'Variable:/Soma:MinDadp').Value = 4652/2
...
sim.createEntity('Variable', 'Variable:/Soma/Surface:MinDEE').Value = 1993
