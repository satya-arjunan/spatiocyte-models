...
sim.createEntity('Variable', 'Variable:/Soma:MinDatp').Value = 6316/2
sim.createEntity('Variable', 'Variable:/Soma:MinDadp').Value = 6316/2
...
sim.createEntity('Variable', 'Variable:/Soma/Surface:MinDEE').Value = 2707
