...
sim.createEntity('Variable', 'Variable:/Soma:MinDatp').Value = 3453/2
sim.createEntity('Variable', 'Variable:/Soma:MinDadp').Value = 3453/2
...
sim.createEntity('Variable', 'Variable:/Soma/Surface:MinDEE').Value = 1480
