...
sim.createEntity('Variable', 'Variable:/Soma:MinDatp').Value = 5534/2
sim.createEntity('Variable', 'Variable:/Soma:MinDadp').Value = 5534/2
...
sim.createEntity('Variable', 'Variable:/Soma/Surface:MinDEE').Value = 2371
