...
sim.createEntity('Variable', 'Variable:/Soma:MinDatp').Value = 3164/2
sim.createEntity('Variable', 'Variable:/Soma:MinDadp').Value = 3164/2
...
sim.createEntity('Variable', 'Variable:/Soma/Surface:MinDEE').Value = 2400
