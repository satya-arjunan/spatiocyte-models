...
theSimulator.createEntity('Variable', 'Variable:/:LENGTHX').Value = 4.45e-6
...
theSimulator.createEntity('Variable', 'Variable:/:MinDadp').Value = 1300
...
theSimulator.createEntity('Variable', 'Variable:/Surface:MinDEE').Value = 700
