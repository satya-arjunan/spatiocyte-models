...
theSimulator.createEntity('Variable', 'Variable:/:LENGTHX').Value = 100e-6*3
theSimulator.createEntity('Variable', 'Variable:/:LENGTHY').Value = 100e-6*3
...
theSimulator.createEntity('Variable', 'Variable:/:MinEm').Value = 1000*9
theSimulator.createEntity('Variable', 'Variable:/:MinDEm').Value = 26700*9
...
populator.VariableReferenceList = [['_', 'Variable:/:MinDEm']]
