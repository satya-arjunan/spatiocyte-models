...
sim.VoxelRadius = 100e-9/20
sim.SearchVacant = 0

theSimulator.rootSystem.StepperID = 'SS'
theSimulator.createEntity('Variable', 'Variable:/:GEOMETRY').Value = 0
theSimulator.createEntity('Variable', 'Variable:/:LENGTHX').Value = 100e-6/20
theSimulator.createEntity('Variable', 'Variable:/:LENGTHY').Value = 100e-6/20
theSimulator.createEntity('Variable', 'Variable:/:LENGTHZ').Value = 1e-6/20
