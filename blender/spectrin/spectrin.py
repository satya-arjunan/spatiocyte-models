...
theSimulator.createEntity('Variable', 'Variable:/:LENGTHY').Value = 8e-7 #1e-6
theSimulator.createEntity('Variable', 'Variable:/:LENGTHZ').Value = 8e-7 #1e-6
...
theSimulator.createEntity('Variable', 'Variable:/Surface:Band3').Value = 215
theSimulator.createEntity('Variable', 'Variable:/Surface:freeBand3').Value = 200
...
log = theSimulator.createEntity('CoordinateLogProcess', 'Process:/:coord')
log.VariableReferenceList = [['_', 'Variable:/Surface:Spectrin']]
log.VariableReferenceList = [['_', 'Variable:/Surface:Band3']]
log.VariableReferenceList = [['_', 'Variable:/Surface:freeBand3']]
log.VariableReferenceList = [['_', 'Variable:/Surface:Edge']]
...
pop.VariableReferenceList = [['_', 'Variable:/Surface:freeBand3']]
