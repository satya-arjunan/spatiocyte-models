...
iterator.VariableReferenceList = [['_', 'Variable:/Surface:Band3phos'],
                                  ['_', 'Variable:/Surface:Band3'],
                                  ['_', 'Variable:/Surface:hemiBand3phos']]
iterator.Iterations = 1
iterator.LogStart = 1
iterator.LogEnd = 100
iterator.LogInterval = 0.05
iterator.FileName = "case3c.4800_band3_cluster_different_diffusion.lifetime.csv"
