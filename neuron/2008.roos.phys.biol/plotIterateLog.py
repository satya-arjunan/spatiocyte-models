...
for i in range(colSize):
  P.plot(np.divide(data[0],60.0), data[i+1], ls=lines[i], color=colors[i], label=speciesNames[i], linewidth=1.5)

P.plot(np.divide(data[0],60.0), combined)

print np.amax(combined)
