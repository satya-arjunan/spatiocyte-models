...
angle = math.pi/4
somaVectorZ = [0.0, 0.0, 1.0]
somaVectorZpoint = [0.0, 0.0, 0.0]
A = [0.5, 0, 0]
A = rotatePointAlongVector(A, somaVectorZpoint, somaVectorZ, angle)
B = rotatePointAlongVector(A, somaVectorZpoint, somaVectorZ, angle*2)
C = rotatePointAlongVector(B, somaVectorZpoint, somaVectorZ, angle*2)
D = rotatePointAlongVector(C, somaVectorZpoint, somaVectorZ, angle*2)
