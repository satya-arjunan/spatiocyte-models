...
nBin = 1
binLength = 0.4e-6
filename = "histogram_%d_%d_%.2f_n0.csv" %(int(V1), int(V2), V3)
neuriteLength = nBin*binLength
Filaments = 13
MTRadius = 12.5e-9
VoxelRadius = 0.4e-8
KinesinRadius = 0.4e-8
neuriteRadius = 0.4e-6
pPlusEnd_Detach = 1
...
#elif(nNeuriteMT == 4):
#  y = neuriteRadius*1.3*math.cos(math.pi/3)
#  y2 = y*math.cos(math.pi/3)
#  z = y*math.sin(math.pi/3)
#  MTsOriginY[1] = y/neuriteRadius
#  MTsOriginY[2] = -y2/neuriteRadius
#  MTsOriginZ[2] = -z/neuriteRadius
#  MTsOriginY[3] = -y2/neuriteRadius
#  MTsOriginZ[3] = z/neuriteRadius
elif(nNeuriteMT == 4):
  ...
  space = (neuriteRadius*2-MTRadius*2*2)/(2+4)
  MTsOriginY[1] = -1+(space+MTRadius)/neuriteRadius
  MTsOriginY[2] = 1-(space+MTRadius)/neuriteRadius
  space = (neuriteRadius*2-MTRadius*2*2)/(2+4)
  MTsOriginZ[3] = -1+(space+MTRadius)/neuriteRadius
  MTsOriginZ[4] = 1-(space+MTRadius)/neuriteRadius
elif(nNeuriteMT == 6):
  y = neuriteRadius*1.1*math.cos(math.pi/3)
  y2 = y*math.cos(math.pi/3)
  z = y*math.sin(math.pi/3)
  MTsOriginY[0] = y/neuriteRadius
  MTsOriginY[1] = -y2/neuriteRadius
  ...
  MTsOriginY[2] = -y2/neuriteRadius
  MTsOriginZ[2] = z/neuriteRadius
  MTsOriginY[3] = -y/neuriteRadius
  MTsOriginY[4] = y2/neuriteRadius
  MTsOriginZ[4] = -z/neuriteRadius
  MTsOriginY[5] = y2/neuriteRadius
  MTsOriginZ[5] = z/neuriteRadius
elif(nNeuriteMT == 7):
  y = neuriteRadius*1.3*math.cos(math.pi/3)
  y2 = y*math.cos(math.pi/3)
  z = y*math.sin(math.pi/3)
  ...
  MTsOriginY[3] = -y2/neuriteRadius
  MTsOriginZ[3] = z/neuriteRadius
  MTsOriginY[4] = -y/neuriteRadius
  MTsOriginY[5] = y2/neuriteRadius
  MTsOriginZ[5] = -z/neuriteRadius
  MTsOriginY[6] = y2/neuriteRadius
  MTsOriginZ[6] = z/neuriteRadius
elif(nNeuriteMT == 8):
