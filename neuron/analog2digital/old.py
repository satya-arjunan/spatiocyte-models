...
rodsLengthX[nRod-1] = rodsLengthX[nRod-1]-0.5e-6
...
for i in range(nRod):
  ...
  h.Length = rodsLengthX[i]-inSomaLength/2
  h.OriginX = 0.2
...
sim.createEntity('Variable', 'Variable:/Soma:MinDadp').Value = 2387
...
sim.createEntity('Variable', 'Variable:/Soma/Surface:MinDEE').Value = 1023
