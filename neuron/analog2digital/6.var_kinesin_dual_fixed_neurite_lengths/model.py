...
pPlusEnd_Detach = 1
VoxelRadius = 0.8e-8
neuriteLengths = [8e-6, 8e-6, 8e-6, 8e-6, 8e-6, 8e-6, 8e-6, 8e-6]
nNeurite = len(neuriteLengths)
nNeuriteMT = 5
...
h = sim.createEntity('HistogramLogProcess', 'Process:/Soma:Histogram')
...
h.Density = 1
h.Length = somaWidth
h.Radius = somaLength/2
h.Bins = 10
h.LogInterval = 1e-1
h.ExposureTime = 40
h.RotateZ = math.pi/2
h.FileName = "histogram_soma" + filename + ".csv"
h.LogEnd = T-1
h.Iterations = 1
