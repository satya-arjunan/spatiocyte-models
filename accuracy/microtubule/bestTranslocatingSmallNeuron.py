...
theSimulator.createEntity('Variable', 'Variable:/Soma:IndicatorSubunit').Value = 0
theSimulator.createEntity('Variable', 'Variable:/Soma:IndicatorInterface').Value = 0
theSimulator.createEntity('Variable', 'Variable:/Soma:IndicatorVoxel').Value = 0
...
visualLogger.VariableReferenceList = [['_', 'Variable:/Soma:IndicatorSubunit']]
visualLogger.VariableReferenceList = [['_', 'Variable:/Soma:IndicatorInterface']]
visualLogger.VariableReferenceList = [['_', 'Variable:/Soma:IndicatorVoxel']]
...
for i in range(somaMTs):
  for j in range(3):
    ...
    Microtubule.VariableReferenceList = [['_', 'Variable:/Soma:IndicatorSubunit' ]]
